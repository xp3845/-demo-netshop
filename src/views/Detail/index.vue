...
import Detail from './components/DetailHot.vue'
...
<template>
  <div class="xtx-goods-page">
    <div class="container" v-if="goods.details"><!-- v-if控制渲染 <div class="container" v-if="goods.details"> -->
      <div class="bread-container">
        <el-breadcrumb separator=">">
        <!-- 可选链？. 若有值则继续渲染 ${goods.categories?.[1].id}`}-->
